...
public class VueAjouterClient extends JFrame {

    JTextField id, nom, prenom, mail;
    JButton ajouter;
    Parc parc;

    public VueAjouterClient(Parc p) {
        this.parc = p;
        ...
        id.setMinimumSize(new Dimension(250,30));
        id.setPreferredSize(new Dimension(250, 30));
        
        nom.setMaximumSize(new Dimension(250, 30));
        nom.setMinimumSize(new Dimension(250, 30));
        nom.setPreferredSize(new Dimension(250, 30));
        
        prenom.setMaximumSize(new Dimension(250, 30));
        prenom.setMinimumSize(new Dimension(250, 30));
        prenom.setPreferredSize(new Dimension(250, 30));
        
        mail.setMaximumSize(new Dimension(250, 30));
        mail.setMinimumSize(new Dimension(250, 30));
        ...
        nom.setBackground(new Color(200,200,200));
        prenom.setBackground(new Color(200,200,200));
        mail.setBackground(new Color(200,200,200));
        ...
        ajouter.addActionListener(
            new ContAjoutClient(parc, id, nom, prenom, mail)
        );
